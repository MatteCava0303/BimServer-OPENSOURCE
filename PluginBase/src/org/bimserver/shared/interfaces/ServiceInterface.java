...
public interface ServiceInterface extends PublicInterface {
	...
	@WebMethod(action = "deletePhysicallyProject")
	Boolean deletePhysicallyProject(
		@WebParam(name = "poid", partName = "deletePhysicallyProject.poid") Long poid) throws ServerException, UserException;
